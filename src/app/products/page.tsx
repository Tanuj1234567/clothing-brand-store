    ...
    <div className="grid gap-8 md:grid-cols-[260px_1fr]">
      <aside className="h-fit rounded-2xl border border-zinc-200 p-5 dark:border-zinc-800">
        ...
        <div className="mt-4 space-y-3 text-sm">
          <Link href="/products?sort=price_asc" className="block">Price: Low to High</Link>
          <Link href="/products?sort=price_desc" className="block">Price: High to Low</Link>
          <Link href="/products?category=Men" className="block">Men</Link>
          <Link href="/products?category=Women" className="block">Women</Link>
          <Link href="/products?category=Streetwear" className="block">Streetwear</Link>
        </div>
      </aside>
      <section>
        <h1 className="mb-6 text-2xl font-semibold">All Products</h1>
